...
def build_explorer_dataset(dataset: str, source: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "selected_strategy": selected_strategy,
        "selected_threshold": to_float(result_row["selected_threshold"]),
        ...
        "metrics": {
            "default": {
                "accuracy": to_float(result_row["test_default_accuracy"]),
                "precision": to_float(result_row["test_default_precision"]),
                "recall": to_float(result_row["test_default_recall"]),
                "f1": to_float(result_row["test_default_f1"]),
            },
            "tuned": {
                "accuracy": to_float(result_row["test_tuned_accuracy"]),
                "precision": to_float(result_row["test_tuned_precision"]),
                "recall": to_float(result_row["test_tuned_recall"]),
                "f1": to_float(result_row["test_tuned_f1"]),
            },
            "selected": {
                "accuracy": to_float(result_row[f"test_{selected_strategy}_accuracy"]),
                "precision": to_float(result_row[f"test_{selected_strategy}_precision"]),
                "recall": to_float(result_row[f"test_{selected_strategy}_recall"]),
                "f1": to_float(result_row[f"test_{selected_strategy}_f1"]),
            },
        },
